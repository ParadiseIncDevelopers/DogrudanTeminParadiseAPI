...
builder.Services.AddScoped(sp => new MongoDBRepository<BackupInspectionAcceptanceCertificate>(cfg["MongoAPI"], cfg["MongoBackupDBName"], "BackupInspectionAcceptanceCertificates"));
builder.Services.AddScoped(sp => new MongoDBRepository<BackupAdditionalInspectionAcceptanceCertificate>(cfg["MongoAPI"], cfg["MongoBackupDBName"], "BackupAdditionalInspectionAcceptanceCertificates"));
